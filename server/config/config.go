...
type (
	...
	RABBIT_MQ_CONFIG struct {
		...
		REPOSITORY_RUN_ROUTING_KEY   string
		REPOSITORY_RUN_QUEUE         string
		REPOSITORY_STOP_ROUTING_KEY  string
		REPOSITORY_STOP_QUEUE        string
	}
)
...
func setFromEnv(config *Config) {
	...
	config.RABBIT_MQ_CONFIG.REPOSITORY_STOP_QUEUE = viper.GetString("RABBIT_MQ_REPOSITORY_STOP_QUEUE")
	config.RABBIT_MQ_CONFIG.REPOSITORY_STOP_ROUTING_KEY = viper.GetString("RABBIT_MQ_REPOSITORY_STOP_ROUTING_KEY")
